...
<head>
  ...
  <title>The Gallery Cafe test customer</title>


  <link rel="shortcut icon" href="./favicon.svg" type="image/svg+xml">


  <link rel="stylesheet" href="./assets/css/cus style.css">
  ...
  <header class="header" data-header>
    <div class="container">
      ...
      <div class="header-btn-group">
        ...
        <a href="index.php"><button class="log-btn-hover" >Log out</button></a>
      ...
      <section class="section food-menu" id="food-menu">
        <div class="container">
          ...
          <p class="section-text">
           ...
           <a href="./Customer/cus food.php" id="food-btn"><button>See Here</button></a>
...
<h1>Weekly Offers</h1>  
    ...
    <a href="./Customer/cus food.php"><button id="oder-now-btn">Oder Now</button></a>
      ...
      <section class="section section-divider gray delivery">
        <div class="container">
          ...
          <div class="delivery-content">
            ...
            <a href="./Customer/cus food.php"> <button class="btn btn-hover">Order Now</button></a>
          </div>
          ...
          <figure class="delivery-banner">
            <img src="./assets/images/delivery-banner-bg.png" width="700" height="602" loading="lazy" alt="clouds"
              ...
              <img src="./assets/images/delivery-boy.svg" width="1000" height="880" loading="lazy" alt=""
      ...
      <section class="section section-divider gray table delivery">
        <div class="container">

          <div class="table-content">

            <h2 class="h2 section-title">
              Hire your own<br>Tables 
            </h2>

            <p class="section-text">
              "Ensure your dining experience is perfect with our table hire service. By booking in advance, you secure the right time and place for your gathering, allowing you to enjoy a seamless and enjoyable meal. Whether it's a business lunch, a family celebration, or a romantic dinner, our reservation system helps you choose the ideal spot and time to match your needs. Let us handle the details so you can focus on savoring great food and great company.
            </p>

            <a href="./Customer/Reservation.php"><button class="btn btn-hover">reservation Now</button></a>
          </div>

          <figure class="table-banner">
          
            <img src="./assets/images/table.jpg" width="1200" height="1000" loading="lazy" alt=""
              class="w-100 table-img" data-delivery-boy>
          </figure>
      ...
      <section class="section section-divider gray delivery">
        <div class="container">
          ...
          <div class="park-content">
            ...
            <a href="./Customer/park.php"><button class="btn btn-hover">reservation Now</button></a>
          </div>
